package cn.iocoder.yudao.module.ocr.utils;
...
public class ImageUtils {
    ...
    static {
        Map<Integer, Color> tempMap = new HashMap<>();
        tempMap.put(0, new Color(200, 0, 0));
        tempMap.put(1, new Color(0, 200, 0));
        tempMap.put(2, new Color(0, 0, 200));
        tempMap.put(3, new Color(200, 200, 0));
        tempMap.put(4, new Color(200, 0, 200));
        tempMap.put(5, new Color(0, 200, 200));
